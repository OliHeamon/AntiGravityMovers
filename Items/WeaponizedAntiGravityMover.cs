...
{
	public class WeaponizedAntiGravityMover : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Weaponized Anti-Gravity Mover");
		...
		public override void SetDefaults()
		{
			...
			item.useTime = 6;
			item.shoot = ModContent.ProjectileType<WeaponizedAntiGravBeam>();
			item.shootSpeed = 10;
			item.channel = true;
			item.magic = true;
			item.noMelee = true;
